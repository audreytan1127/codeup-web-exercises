...
console.log('Users with three languages: ',userLanguages);

// CLASS WALK THRU
// const threeLang = users.filter(user => user.language.length >= 3);
...
// console.log('Users emails: ', emailArray);
...
// // CLASS WALK THRU
// const avgYears = users.reduce((accumulator, user,index)=> {
//     accumulator += parseFloat(user.yearsOfExperience);
// //Ability to run conditional in loop, this will run average at the end of loop!!
...
// COULD ALSO LOG THE TOTAL YEARS AND DIVIDE BY USERS.LENGTH!
...
//
// ///////////This just concatenates all the user names together with a comma between....
...
// /////////////////This concatenates the usernames together with comma other than last one which has and, and a period before.
// // CLASS WALK THRU
